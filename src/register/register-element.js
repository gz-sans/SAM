...
import styleCssn from "./register-style";
export class Registrer extends LitElement {
  static get styles() {
    return [styleCssn];
  }
            ...
            <div class="card">
                ...
                <div class="card-header bg-danger-1">
                    ...
                    <div class="card-body">
                        ...
                        <form class="text-center" @submit="${this.salir}">
                        <button type="submit" class="btn-danger-1">salir</button>
                        </form>
...
customElements.define("register-element", Registrer);
